...
public class WebCrawler implements Runnable {
	...
	public void run() {
		...
		bw.append("ID,Name,Price,Colour,Size,Stock,Category 1, Category 2, Sale, Date, URL");
		bw.append("\r\n");
		while (true) {
	...
	private void processPage(WebURL curURL, FileWriter fw, PrintWriter bw,
			WebDriver driver) {
		if (curURL == null) {
			return;
		}
